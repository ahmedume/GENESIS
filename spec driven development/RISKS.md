...
| 9 | **Generic AI look ("slop")** — the site reads as template output | Low | High | DESIGN-SYSTEM.md anti-slop rules are hard constraints; committed cinematic-realism identity (real textures, volumetrics, asymmetric HUD); every visual choice traces to a spec line | Any element that could appear in a thousand other sites |
